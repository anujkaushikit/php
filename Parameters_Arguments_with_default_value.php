...
function multiply_with_parameters($num_1, $num_2 = 5){ // when you create a function that time you pass parameters in function 
    $result = $num_1 * $num_2;
    echo "two number multiply with parameters and with default value is 5, number one is {$num_1} and number two is {$num_2} multiply result is.{$result} </br>";
}
multiply_with_parameters(25,20);// when you call a function that time you pass the value behalf of parameter is called argument in function 
